...
%%%
	...
	\section*{Abstract}
		...
		\begin{itemize}
			...
			\item work on abstract DONE
			\item derive conclusion from abstract DONE 
	...
	\section{Analysis}
		...
		[WRITE DISCUSSION]???
		In this section we expose the results of the comparison of person coefficients obtained using both the WLS and the GLM selected models 
